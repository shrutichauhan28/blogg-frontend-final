    ...
    fetch('https://blogggapp-server-production.up.railway.app/articles')
        ...
        .then(data => {
            if (data.length > 0) {
                ...
                featuredPostImage.src = featuredArticle.imageLink || './images/recipes/11.jpg';
                ...
                const previewText = featuredArticle.body.substring(0, 100).replace(/<\/?p>/g, '') + '...';
            ...
            data.forEach(article => {
                ...
                postImage.src = article.imageLink || './images/recipes/11.jpg';
